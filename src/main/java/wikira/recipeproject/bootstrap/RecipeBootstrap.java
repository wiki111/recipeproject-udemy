package wikira.recipeproject.bootstrap;

import lombok.extern.slf4j.Slf4j;
import org.springframework.context.ApplicationListener;
import org.springframework.context.event.ContextRefreshedEvent;
import org.springframework.stereotype.Component;
import wikira.recipeproject.domain.*;
import wikira.recipeproject.repositories.CategoryRepository;
import wikira.recipeproject.repositories.RecipeRepository;
import wikira.recipeproject.repositories.UnitRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public RecipeBootstrap(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitRepository unitRepository) {
        ...
        log.debug("I'm creating RecipeBootstrap object!");
    }
    ...
    private List<Recipe> getRecipes(){
        ...
        Optional<UnitOfMeasure> eachUomOptional = unitRepository.findByUnit("Each");

        if(!eachUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM not found.");
        }

        Optional<UnitOfMeasure> tableSpoonUomOptional = unitRepository.findByUnit("Tablespoon");

        if(!eachUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM not found.");
        }

        Optional<UnitOfMeasure> teaSpoonUomOptional = unitRepository.findByUnit("Teaspoon");

        if(!eachUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM not found.");
        }

        Optional<UnitOfMeasure> dashUomOptional = unitRepository.findByUnit("Dash");

        if(!eachUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM not found.");
        }

        Optional<UnitOfMeasure> pintUomOptional = unitRepository.findByUnit("Pint");

        if(!eachUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM not found.");
        }

        Optional<UnitOfMeasure> cupsUomOptional = unitRepository.findByUnit("Cup");
        ...
        guacRecipe.setDirections("1 Cut avocado, remove flesh: Cut the avocados in half. Remove seed. Score the inside of the avocado with a blunt knife and scoop out the flesh with a spoon" +
                ...
                "\n" +
                "\n" +
                "Read more: http://www.simplyrecipes.com/recipe/perfect_guacamole/#ixzz4jvpiV9Sd");
        ...
        guacNotes.setRecipeNotes("For a very quick guacamole just take a 1/4 cup of salsa and mix it in with your mashed avocados.\n" +
                ...
                "\n" +
                "\n" +
                "Read more: http://www.simplyrecipes.com/recipe/perfect_guacamole/#ixzz4jvoun5ws");
        ...
        tacosRecipe.setDirections("1 Prepare a gas or charcoal grill for medium-high, direct heat.\n" +
                ...
                "\n" +
                "\n" +
                "Read more: http://www.simplyrecipes.com/recipe/spicy_grilled_chicken_tacos/#ixzz4jvtrAnNm");
        ...
        tacoNotes.setRecipeNotes("We have a family motto and it is this: Everything goes better in a tortilla.\n" +
                ...
                "\n" +
                "\n" +
                "Read more: http://www.simplyrecipes.com/recipe/spicy_grilled_chicken_tacos/#ixzz4jvu7Q0MJ");
